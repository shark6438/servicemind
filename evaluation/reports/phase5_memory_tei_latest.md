...
- 打分模式：`embedding`
- 打分模型：`BAAI/bge-m3@5617a9f61b028005a4858fdac845db406aefb181`
- 时间锚点：`2026-09-22T00:46:58.633822+00:00`
...
打分模式 `embedding`（模型 `BAAI/bge-m3@5617a9f61b028005a4858fdac845db406aefb181`）；仅统计声明了 `must_surface` 的探针。
...
| 探针 | 记忆通道余量 | 实际占用 | 判定 |
| --- | --- | --- | --- |
| p-preference | 5749 | 370 | 送达 |
| p-procedure | 5738 | 390 | 送达 |
| p-fleet-vpn-causes | 5742 | 370 | 送达 |
| p-post-run-tenant-episode | 5749 | 401 | 送达 |
